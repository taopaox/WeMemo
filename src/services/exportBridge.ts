...
const OPEN_SINGLE_EXPORT_EVENT = 'wememo:open-single-export'
const EXPORT_SESSION_STATUS_EVENT = 'wememo:export-session-status'
const EXPORT_SESSION_STATUS_REQUEST_EVENT = 'wememo:export-session-status-request'
const SINGLE_EXPORT_DIALOG_STATUS_EVENT = 'wememo:single-export-dialog-status'
