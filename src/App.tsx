        ...
        <div className="agreement-overlay">
          <div className="agreement-modal">
            ...
            <div className="agreement-content">
              <p>欢迎使用WeMemo！在使用本软件前，请仔细阅读以下条款：</p>
              <div className="agreement-notice">
                <strong>这是免费软件，如果你是付费购买的话请骂死那个骗子。</strong>
                <span className="agreement-notice-link">
                  官方网站：
                  <a href="https://github.com/taopaox/WeMemo" target="_blank" rel="noreferrer">
                    https://github.com/taopaox/WeMemo
                  </a>
                  &nbsp;·&nbsp;
                  <a href="https://github.com/taopaox/WeMemo" target="_blank" rel="noreferrer">
                    GitHub 仓库
      ...
      {showAnalyticsConsent && !agreementLoading && (
        <div className="agreement-overlay">
          <div className="agreement-modal">
            ...
            <div className="agreement-content">
              <div className="agreement-text">
                <p>为了持续改进 WeMemo 并提供更好的用户体验，我们希望收集一些匿名的使用数据。</p>
