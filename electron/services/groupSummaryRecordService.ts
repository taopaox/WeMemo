...
class GroupSummaryRecordService {
  ...
  private resolveFilePath(): string {
    ...
    this.filePath = path.join(this.resolveUserDataPath(), 'wememo-group-summary-records.json')
    return this.filePath
  }

  private resolveLogDir(): string {
    if (this.logDir) return this.logDir
    this.logDir = path.join(this.resolveUserDataPath(), 'wememo-group-summary-logs')
